...
plot(res_find_k_1, estim_posed_random_1,estim_posed_random_2)+
  geom_vline(xintercept = 3)
...
mean(abs(cor(NMF::basis(res_find_k_1$fit$`2`), NMF::basis(estim_posed_random_2$fit$`2`) )))
mean(abs(cor(NMF::basis(res_find_k_1$fit$`3`), NMF::basis(estim_posed_random_2$fit$`3`) )))
mean(abs(cor(NMF::basis(res_find_k_1$fit$`4`), NMF::basis(estim_posed_random_2$fit$`4`) )))
mean(abs(cor(NMF::basis(res_find_k_1$fit$`5`), NMF::basis(estim_posed_random_2$fit$`5`) )))
mean(abs(cor(NMF::basis(res_find_k_1$fit$`6`), NMF::basis(estim_posed_random_2$fit$`6`) )))
