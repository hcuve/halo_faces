...
rslt_trans_entropy<-lmer(trans_entropy_norm~ expression*posed_spoken+
...
emmeans::emmeans(rslt_trans_entropy, pairwise~expression)
emmeans::emmeans(rslt_trans_entropy, pairwise~expression|posed_spoken)
