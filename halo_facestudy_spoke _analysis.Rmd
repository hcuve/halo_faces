...
confusionMatrix(test_set_temp$prediction , as.factor(test_set_temp$expression), mode = "everything", positive="1")[["overall"]][["Accuracy"]]
...
acc_test_ci<- bind_rows(acc_test_ci,as.data.frame(acc_temp))
message("Done Loop - ", i)
