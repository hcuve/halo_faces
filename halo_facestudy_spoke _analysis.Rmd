...
posed_spoken_bindrows_ts%>%
 ...
 colnames(posed_spoken_bindrows_ts_agg)
 
pcatest<- prcomp(posed_spoken_bindrows_ts_agg[,c(14:16,20:28)])$x[,1:2]
posed_spoken_bindrows_ts_agg$PC1<- pcatest[,1]
posed_spoken_bindrows_ts_agg$PC2<- pcatest[,2]
pcatest$x[,1:2]
