...
# agg 2 for plotting components only
...
delaunay_tri_all<- do.call(rbind, lapply(seq_along(tri), 
  ...
  data.frame(x_new_norm_rot2 = tri[[x]]$x, y_new_norm_rot2 = tri[[x]]$y, 
             coef_fill = mean(df_OF_output_land_posed_binned_select_alligned_eyes_agg$coef_fill_AUcomp_nmf_max_norm[tri[[x]]$ptNum]),
             tri = x)
  })) |>
...
delaunay_posed_plots<-list()

delaunay_posed_plots$posed_triang_ang_comp1 <-
do.call(rbind, lapply(seq_along(tri_ang), 
                      function(x) {
  data.frame(x_new_norm_rot2 = tri_ang[[x]]$x, 
             y_new_norm_rot2 = tri_ang[[x]]$y, 
 coef_fill = mean(anger_del$cor_comp1_land_cum_diff_fill_sq_max_norm[tri_ang[[x]]$ptNum]),
             tri_ang = x)
  })) |>
  ggplot(aes(x_new_norm_rot2, 1-y_new_norm_rot2)) +
  # tri
...
do.call(rbind, lapply(seq_along(tri_ang), 
  ...
  data.frame(x_new_norm_rot2 = tri_ang[[x]]$x, 
             y_new_norm_rot2 = tri_ang[[x]]$y, 
 coef_fill = mean(anger_del$cor_comp2_land_cum_diff_fill_sq_max_norm[tri_ang[[x]]$ptNum]),
             tri_ang = x)
  })) |>
  ggplot(aes(x_new_norm_rot2, 1-y_new_norm_rot2)) +
  # tri
...
do.call(rbind, lapply(seq_along(tri_ang), 
  ...
  data.frame(x_new_norm_rot2 = tri_ang[[x]]$x, 
             y_new_norm_rot2 = tri_ang[[x]]$y, 
 coef_fill = mean(anger_del$cor_comp3_land_cum_diff_fill_sq_max_norm[tri_ang[[x]]$ptNum]),
             tri_ang = x)
  })) |>
  ggplot(aes(x_new_norm_rot2, 1-y_new_norm_rot2)) +
  # tri
...
find the correct displays for components
```{r}
delaunay_posed_plots$posed_tri_comp1
delaunay_posed_plots$posed_tri_comp2
delaunay_posed_plots$posed_tri_comp3
...
require(patchwork)
  ...
  triangle_plots$delaunay_tri_ang/
    (delaunay_posed_plots$posed_triang_ang_comp1|delaunay_posed_plots$posed_triang_ang_comp2|delaunay_posed_plots$posed_triang_ang_comp3)
...
delaunay_posed_plots$posed_triang_happy_comp1 <-
do.call(rbind, lapply(seq_along(tri_happy), 
                      function(x) {
  data.frame(x_new_norm_rot2 = tri_happy[[x]]$x, 
             y_new_norm_rot2 = tri_happy[[x]]$y, 
 coef_fill = mean(happy_del$cor_comp1_land_cum_diff_fill_sq_max_norm[tri_happy[[x]]$ptNum]),
             tri_happy = x)
  })) |>
  ggplot(aes(x_new_norm_rot2, 1-y_new_norm_rot2)) +
  # tri
...
do.call(rbind, lapply(seq_along(tri_happy), 
  ...
  data.frame(x_new_norm_rot2 = tri_happy[[x]]$x, 
             y_new_norm_rot2 = tri_happy[[x]]$y, 
 coef_fill = mean(happy_del$cor_comp2_land_cum_diff_fill_sq_max_norm[tri_happy[[x]]$ptNum]),
             tri_happy = x)
  })) |>
  ggplot(aes(x_new_norm_rot2, 1-y_new_norm_rot2)) +
  # tri
...
do.call(rbind, lapply(seq_along(tri_happy), 
  ...
  data.frame(x_new_norm_rot2 = tri_happy[[x]]$x, 
             y_new_norm_rot2 = tri_happy[[x]]$y, 
 coef_fill = mean(happy_del$cor_comp3_land_cum_diff_fill_sq_max_norm[tri_happy[[x]]$ptNum]),
             tri_happy = x)
  })) |>
  ggplot(aes(x_new_norm_rot2, 1-y_new_norm_rot2)) +
  # tri
...
delaunay_posed_plots$posed_triang_sad_comp1 <-
do.call(rbind, lapply(seq_along(tri_sad), 
                      function(x) {
  data.frame(x_new_norm_rot2 = tri_sad[[x]]$x, 
             y_new_norm_rot2 = tri_sad[[x]]$y, 
 coef_fill = mean(happy_del$cor_comp1_land_cum_diff_fill_sq_max_norm[tri_sad[[x]]$ptNum]),
             tri_sad = x)
  })) |>
  ggplot(aes(x_new_norm_rot2, 1-y_new_norm_rot2)) +
  # tri
...
```{r}
delaunay_posed_plots$posed_triang_sad_comp2 <-
do.call(rbind, lapply(seq_along(tri_sad), 
                      function(x) {
  data.frame(x_new_norm_rot2 = tri_sad[[x]]$x, 
             y_new_norm_rot2 = tri_sad[[x]]$y, 
 coef_fill = mean(happy_del$cor_comp2_land_cum_diff_fill_sq_max_norm[tri_sad[[x]]$ptNum]),
             tri_sad = x)
  })) |>
  ggplot(aes(x_new_norm_rot2, 1-y_new_norm_rot2)) +
  # tri
...
do.call(rbind, lapply(seq_along(tri_sad), 
  ...
  data.frame(x_new_norm_rot2 = tri_sad[[x]]$x, 
             y_new_norm_rot2 = tri_sad[[x]]$y, 
 coef_fill = mean(happy_del$cor_comp3_land_cum_diff_fill_sq_max_norm[tri_sad[[x]]$ptNum]),
             tri_sad = x)
  })) |>
  ggplot(aes(x_new_norm_rot2, 1-y_new_norm_rot2)) +
  # tri
...
delaunay_posed_data<-list()

delaunay_posed_data$posed_tri_comp1 <-
triang.list(deldir(df_OF_output_land_posed_binned_select_alligned_eyes_agg2$x_new_norm_rot2, 
...
# delaunay_posed_plots$posed_tri_comp1<-
delaunay_posed_plots$posed_tri_comp1
do.call(rbind, lapply(seq_along(delaunay_posed_data$posed_tri_comp1), 
                      function(x) {
  data.frame(x_new_norm_rot2 = posed_tri_comp1test[[x]]$x, y_new_norm_rot2 = posed_tri_comp1test[[x]]$y, 
             coef_fill = mean(df_OF_output_land_posed_binned_select_alligned_eyes_agg2$cor_comp1_land_cum_diff_fill_sq_max_norm[posed_tri_comp1test[[x]]$ptNum]),
             posed_tri_comp1test = x)
  })) |>
  
   ggplot(aes(x_new_norm_rot2, 1-y_new_norm_rot2)) +
  # tri
  geom_polygon(aes(fill = coef_fill, group = posed_tri_comp1test)) +
...
```{r}
delaunay_posed_data$posed_tri_comp2 <-
triang.list(deldir(df_OF_output_land_posed_binned_select_alligned_eyes_agg2$x_new_norm_rot2, 
                          df_OF_output_land_posed_binned_select_alligned_eyes_agg2$y_new_norm_rot2))
...
delaunay_posed_plots$posed_tri_comp2
# delaunay_posed_plots$posed_tri_comp2<-
do.call(rbind, lapply(seq_along(delaunay_posed_data$posed_tri_comp2), 
                      function(x) {
  data.frame(x_new_norm_rot2 = posed_tri_comp2test[[x]]$x, y_new_norm_rot2 = posed_tri_comp2test[[x]]$y, 
             coef_fill = mean(df_OF_output_land_posed_binned_select_alligned_eyes_agg2$cor_comp2_land_cum_diff_fill_sq_max_norm[posed_tri_comp2test[[x]]$ptNum]),
             posed_tri_comp2test = x)
  })) |>
  
   ggplot(aes(x_new_norm_rot2, 1-y_new_norm_rot2)) +
  # tri
  geom_polygon(aes(fill = coef_fill, group = posed_tri_comp2test)) +
...
delaunay_posed_data$posed_tri_comp3 <-
triang.list(deldir(df_OF_output_land_posed_binned_select_alligned_eyes_agg2$x_new_norm_rot2, 
                          df_OF_output_land_posed_binned_select_alligned_eyes_agg2$y_new_norm_rot2))
...
delaunay_posed_plots$posed_tri_comp3<-
do.call(rbind, lapply(seq_along(delaunay_posed_data$posed_tri_comp3), 
                      function(x) {
  data.frame(x_new_norm_rot2 = posed_tri_comp3test[[x]]$x, y_new_norm_rot2 = posed_tri_comp3test[[x]]$y, 
             coef_fill = mean(df_OF_output_land_posed_binned_select_alligned_eyes_agg2$cor_comp3_land_cum_diff_fill_sq_max_norm[posed_tri_comp3test[[x]]$ptNum]),
             posed_tri_comp3test = x)
  })) |>
  
   ggplot(aes(x_new_norm_rot2, 1-y_new_norm_rot2)) +
  # tri
  geom_polygon(aes(fill = coef_fill, group = posed_tri_comp3test)) +
...
(triangle_plots$delaunay_tri_ang|
   ...
   delaunay_posed_plots$posed_triang_sad_comp2|
   delaunay_posed_plots$posed_triang_sad_comp3)/
  (plot_spacer()|delaunay_posed_plots$posed_tri_comp1|
delaunay_posed_plots$posed_tri_comp2|
delaunay_posed_plots$posed_tri_comp3)
...
triangle_plots$delaunay_tri_comp1<-delaunay_posed_plots$posed_tri_comp1+  theme(plot.background = element_rect(fill = "black"))
triangle_plots$delaunay_tri_comp2<-delaunay_posed_plots$posed_tri_comp2+  theme(plot.background = element_rect(fill = "black"))

triangle_plots$delaunay_tri_comp3 <- delaunay_posed_plots$posed_tri_comp3+ theme(plot.background = element_rect(fill = "black"))
delaunay_posed_plots$posed_triang_ang_comp1
delaunay_posed_plots$posed_triang_ang_comp1
delaunay_posed_plots$posed_triang_happy_comp2
delaunay_posed_plots$posed_triang_sad_comp3
...
ggsave("comp1n.png", device = "png", triangle_plots$delaunay_tri_comp1.1,
       width = 700,
       height = 700,
              units = 'px',
       dpi = 500)
...
ggsave("comp2n.png", device = "png", triangle_plots$delaunay_tri_comp2.1,
       width = 10,
       height = 12,
              # units = 'px',
       dpi = 500)

ggsave("comp3n.png", device = "png", triangle_plots$delaunay_tri_comp3.1,
       width = 10,
       height = 12,
              # units = 'px',
       dpi = 500)
