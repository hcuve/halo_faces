...
ggsave("comp1noct.png", device = "png", triangle_plots$delaunay_tri_comp1,
       width = 700,
       height = 700,
              units = 'px',
       dpi = 500)

ggsave("comp2noct.png", device = "png", triangle_plots$delaunay_tri_comp2,
         width = 700,
       height = 700,
                     units = 'px',
       dpi = 500)
ggsave("comp3noct.png", device = "png", triangle_plots$delaunay_tri_comp3,
           width = 700,
       height = 700,
                     units = 'px',
       dpi = 500)
