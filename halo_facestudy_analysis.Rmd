...
res_k3_fit_H<-as.data.frame(res_k3@fit@H)%>%
...
library(imager)
pathname<-"~/Library/CloudStorage/GoogleDrive-helioclemente.c@gmail.com/My Drive/2022 - University Of Birmingham/HaloStudy/Data/"

file_path <- system.file('/Library/CloudStorage/GoogleDrive-helioclemente.c@gmail.com/My Drive/2022 - University Of Birmingham/HaloStudy/Data/comp1.tiff',package='imager') 
im <- load.image(file_path)
plot(im)
image_read("comp1.tiff")
tiger <- image_read_svg('http://jeroen.github.io/images/tiger.svg', width = 350)


comp1.im= image_read("comp1.png",strip = TRUE)
comp2.im = image_read("comp2.png",strip = TRUE)
comp3.im = image_read("comp3.png",strip = TRUE)  

# comp1.im<- image_convert(comp1.im, format = "png", depth = NULL)
# comp2.im<- image_convert(comp2.im, format = "png", depth = NULL)
# 
# comp3.im<- image_convert(comp3.im, format = "png", depth = NULL)
...
iris
  ...
  iris%>%
   # mutate(label_n = link_to_img(labels))%>%
    ggplot(aes(Species, Sepal.Width)) +
  geom_boxplot()+
        scale_x_discrete(
    name = NULL,
    labels = labels) +
  theme( axis.text.x = element_markdown(color = "black", size = 20))
  
  
  # https://drive.google.com/file/d/1Py4QGB7r4EdIS7YNxyWGBBEKEaqLakwx/view?usp=share_link
  # https://drive.google.com/file/d/1Q0o3bgXZlQafzefXznh3uA27axEBOud5/view?usp=share_link
  # https://drive.google.com/file/d/1Pz34Q0jpK8NL7TXuPQ0d_q-fJYFXietT/view?usp=share_link
  # 
  labels <- c(
  setosa = "<img src='  https://drive.google.com/file/d/1Py4QGB7r4EdIS7YNxyWGBBEKEaqLakwx/view?usp=share_link'
    width='100' /><br>*I. setosa*",
  virginica = "<img src=' https://drive.google.com/file/d/1Q0o3bgXZlQafzefXznh3uA27axEBOud5/view?usp=share_link'
    width='100' /><br>*I. virginica*",
  versicolor = "<img src='  https://drive.google.com/file/d/1Pz34Q0jpK8NL7TXuPQ0d_q-fJYFXietT/view?usp=share_link'
...
directname<- "Library/CloudStorage/GoogleDrive-helioclemente.c@gmail.com/My Drive/2022 - University Of Birmingham/HaloStudy/Github/halo_faces/ggtextimgs"
...
# I is for italic
labels <- c(
  `1` = "<img src='https://github.com/hcuve/halo_faces/raw/main/ggtextimgs/comp1.png'
    width='100' /><br>1 ",
  `2` = "<img src='https://github.com/hcuve/halo_faces/raw/main/ggtextimgs/comp2.png'
    width='100' /><br> 2",
  `3` = "<img src='https://github.com/hcuve/halo_faces/raw/main/ggtextimgs/comp3.png'
    width='100' /><br> 3"
)
...
# First, create a data frame with some sample data
library(ggplot2)
library(png)

# Read in the image file
my_image <- readPNG("comp1.png")
library(ggplot2)
library(grid)

# Load the image and convert it to a grob (graphics object)
img <- png::readPNG("comp1.png")
grob_image <- rasterGrob(img, interpolate=TRUE)

# Create a plot with a blank axis label
p <- ggplot(data, aes(x=x, y=y)) +
  geom_point() +
  theme(axis.text.x=element_blank())

# Add the image as the x-axis label using the `label` argument in the `axis.text.x` element
p + theme(axis.text.x=element_text(label=grob_image))


library(ggplot2)
library(grid)
qplot(speed, dist, data = cars, geom = c("point", "smooth"))+ylim(-10,120)
## `geom_smooth()` using method = 'loess' and formula 'y ~ x'
# ?grid.raster
grid.raster(img, x = -0,y = -10)
```
...
# df_OF_output_AUsW_unblind_posed_binned[,c(2:3,9:10,34:36)]%>%
#   gather(component, coef,-bin_frame, -subject, -expression, -drug.placebo)%>%
#   group_by(bin_framecomponent, drug.placebo, bin_frame)%>%
#   summarise_if(is.numeric, mean, na.rm = TRUE)%>%
#   # ggplot(aes(Dataset, coef , color = Dataset, fill = Dataset))+
#   ggplot(aes(bin_frame, expression, fill= coef, color = ))+
#   geom_smooth(se = F)+
#   # facet_grid(~component)+
#   theme_classic()
...
# plot compoent classification of emotion
