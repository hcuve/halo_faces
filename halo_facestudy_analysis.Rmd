...
left_join(LANDMARKNMF_dcast,NMFresk3test)%>%
  ...
  ungroup()%>%
  ggplot(aes(V1, V2))+
        geom_point(aes(color = coef2))+

  ylim(1,0)+

      # geom_delaunay_segment(aes(x =V1, y = V2, fill = coef, color = coef),
      # lineend = 'round')+
  # geom_delaunay_segment(aes(x =V1, y = V2, fill = coef, color = coef),
      # lineend = 'round')+
   ...
   # geom_delaunay_tile(aes(x = V1_1, y = V2_2, fill = coef2), max.radius = 0.25)+
    scale_color_viridis_c(option = "magma")
     ...
     #                     lineend = 'round')+
   geom_delaunay_tile(aes(fill = coef, color = coef))+

    scale_color_viridis_c(option = "magma")
    geom_delaunay_tile2(aes(x =V1, V2, color = coef2), alpha = 0.3)+
  # geom_delaunay_segment2(colour = Species, group = -1)+
...
# use the NMC AU wights as a scaling parameter
NMFresk3test
    ggforce
