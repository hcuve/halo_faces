...
theme_void()+theme(legend.position = "none",
 ...
 test1<- (wrap_elements(full =chool_talk$AU_NM)|
...
wrap_elements(full = test) + wrap_elements(full = test2) + plot_layout(ncol = 1, nrow = 2, heights = c(1,1.4))
