...
p$graphstyle_int <-  theme(#base plot theme
  ...
  legend.text = element_text(size = 16*(sf+.3)),
  legend.title= element_text(size = 16*(sf+.3)),
...
# I is for italic
labels <- c(
  `3` = "<img src='https://github.com/hcuve/halo_faces/raw/main/ggtextimgs/comp1n.png'
    width='100' /><br> 3",
  `2` = "<img src='https://github.com/hcuve/halo_faces/raw/main/ggtextimgs/comp2n.png'
    width='100' /><br> 2",
  `1` = "<img src='https://github.com/hcuve/halo_faces/raw/main/ggtextimgs/comp3n.png'
    width='100' /><br> 1"
)
# ggtext::
chool_talk$AU_NM<-  chool_talk$AU_NM +
  ...
  # make legend key same height as plot
  make_fullsize <- function() structure("", class = "fullsizebar")
...
comp1_2_3<- triangle_plots$delaunay_tri_comp3.1 /
...
test2 <-(chool_talk$ts_smooth/(triangle_plots$delaunay_tri_ang +
